...
Este repositorio constituye la aplicación de entrada mientras que el enriquecimiento mediante modelos de lenguaje se realiza en [Autoticket-ML](https://github.com/CarlosGolvano/AutoTicket-ML).
